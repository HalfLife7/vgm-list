...
<div>
    ...
    <div v-for="(album, index) in albums" :album="album" :key="index" class="pt-20">
        <div class="flex flex-wrap container m-auto">
            <div class="w-full md:w-2/6">
                <img :src="album.data.covers[0].full" v-if="albumDataIsLoaded" :alt="album.data.name + ' Album Cover'" />
            </div>
            <div class="w-full p-4 md:w-4/6 md:p-0 md:pl-4" v-if="albumDataIsLoaded">
                <div class="text-4xl">{{ album.data.name }}</div>
                <div class="text-xl">Release Date: {{ album.data.release_date }}</div>

                <div class="flex">
                    <div v-for="(store, index) in album.data.stores" :store="store" :key="index">
                        <div class="mr-5 mt-5">
        ...
        <div class="flex flex-wrap container m-auto justify-center mt-4">
            ...
            <table class="table-auto">
                ...
                <tbody>
                    <tr v-for="(track, index) in album.data.tracks" :track="track" :key="index">
                        <td class="border px-4 py-2">{{ track.id }}</td>
                        <td class="border px-4 py-2">{{ track.name }}</td>
                        <td class="border px-4 py-2">{{ track.length }}</td>
                    </tr>
                </tbody>
            </table>
            -->
